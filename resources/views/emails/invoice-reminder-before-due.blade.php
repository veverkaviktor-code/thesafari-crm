                    ...
                    <tr>
                        <td style="padding: 24px 40px;">
                            ...
                            <p style="margin: 0 0 16px 0; font-size: 15px;">
                                náš Karel, který u nás dělá účetnictví, si všiml, že faktura č. <strong>{{ $invoice->invoice_number }}</strong> na částku <strong>{{ number_format((float) $invoice->total, 0, ',', ' ') }} Kč</strong> stále visí na větvi. 🦥
                            </p>

                            <p style="margin: 0 0 16px 0; font-size: 15px;">
                                Splatnost je <strong>{{ $invoice->due_date->format('j. n. Y') }}</strong>, tedy za {{ $daysUntilDue }} {{ $daysUntilDue == 1 ? 'den' : ($daysUntilDue < 5 ? 'dny' : 'dní') }}.
                                Prosíme o kontrolu — pokud vše sedí, budeme rádi za její úhradu.
                            </p>
                            ...
                            <!-- Payment details - amber style (same as other emails) -->
