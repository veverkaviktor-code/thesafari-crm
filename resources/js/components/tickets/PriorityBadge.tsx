...
const priorityConfig: Record<string, { label: string; className: string }> = {
    low: { label: 'Nízká', className: 'bg-gray-500/10 text-[#9C9585] border-gray-500/20' },
...
export default function PriorityBadge({ priority }: PriorityBadgeProps) {
    const config = priorityConfig[priority] ?? { label: priority, className: 'bg-gray-500/10 text-[#9C9585] border-gray-500/20' };
