        ...
        <div className="rounded-xl border border-white/5 bg-[#1a1a22] p-5">
                ...
                <button
                    ...
                    className={cn(
                        ...
                        isRunning
                            ...
                            : 'border-white/10 bg-white/5 hover:border-[#D97706] hover:bg-[#D97706]/10',
                    )}
                >
                    {isRunning ? (
                        <Pause className="h-8 w-8 text-[#D97706]" />
                    ) : (
                        <Play className="h-8 w-8 text-gray-400 transition-colors group-hover:text-[#D97706]" />
                    )}
                </button>
                ...
                <div className="text-center">
                    <p
                        className={cn(
                            ...
                            isRunning ? 'text-[#D97706]' : 'text-gray-500',
                        )}
                    >
                    ...
                    <div className="flex w-full gap-2">
                        ...
                        <div className="relative w-28 shrink-0">
                            <Input
                                ...
                                type="number"
                                min="0"
                                className="border-white/10 bg-white/5 pr-12"
                            />
            ...
            <div className="mt-4 space-y-2 border-t border-white/5 pt-3">
                <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-400">Celkem hodin</span>
                    <span className="text-sm font-medium text-white">
